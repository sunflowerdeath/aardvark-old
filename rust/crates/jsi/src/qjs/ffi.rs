...
fn bindgen_test_layout_JSValueUnion() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSValueUnion>())).float64 as *const _
                as usize
        },
        0usize,
        concat!(
...
fn bindgen_test_layout_JSMallocState() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMallocState>())).malloc_size as *const _
                as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMallocState>())).opaque as *const _
                as usize
        },
        24usize,
        concat!(
...
pub struct JSMallocFunctions {
    ...
    pub js_malloc_usable_size: ::std::option::Option<
        unsafe extern "C" fn(ptr: *const ::std::os::raw::c_void) -> usize,
    >,
}
#[test]
fn bindgen_test_layout_JSMallocFunctions() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMallocFunctions>())).js_free as *const _
                as usize
        },
        8usize,
        concat!(
...
pub type JS_MarkFunc = ::std::option::Option<
    unsafe extern "C" fn(rt: *mut JSRuntime, val: JSValue),
>;
extern "C" {
    pub fn JS_MarkValue(
        rt: *mut JSRuntime,
...
fn bindgen_test_layout_JSMemoryUsage() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).malloc_size as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).memory_used_size
                as *const _ as usize
        },
        16usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).memory_used_count
                as *const _ as usize
        },
        32usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).atom_count as *const _
                as usize
        },
        40usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).atom_size as *const _
                as usize
        },
        48usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).str_count as *const _
                as usize
        },
        56usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).str_size as *const _
                as usize
        },
        64usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).obj_count as *const _
                as usize
        },
        72usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).obj_size as *const _
                as usize
        },
        80usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).prop_count as *const _
                as usize
        },
        88usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).prop_size as *const _
                as usize
        },
        96usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).shape_count as *const _
                as usize
        },
        104usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).shape_size as *const _
                as usize
        },
        112usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).js_func_code_size
                as *const _ as usize
        },
        136usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).js_func_pc2line_size
                as *const _ as usize
        },
        152usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).array_count as *const _
                as usize
        },
        168usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).fast_array_count
                as *const _ as usize
        },
        176usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).fast_array_elements
                as *const _ as usize
        },
        184usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).binary_object_count
                as *const _ as usize
        },
        192usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSMemoryUsage>())).binary_object_size
                as *const _ as usize
        },
        200usize,
        concat!(
...
fn bindgen_test_layout_JSClassExoticMethods() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSClassExoticMethods>()))
                .get_own_property_names as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSClassExoticMethods>())).has_property
                as *const _ as usize
        },
        32usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSClassExoticMethods>())).get_property
                as *const _ as usize
        },
        40usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSClassExoticMethods>())).set_property
                as *const _ as usize
        },
        48usize,
        concat!(
...
pub type JSClassFinalizer = ::std::option::Option<
    unsafe extern "C" fn(rt: *mut JSRuntime, val: JSValue),
>;
...
fn bindgen_test_layout_JSClassDef() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSClassDef>())).class_name as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSClassDef>())).finalizer as *const _
                as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSClassDef>())).call as *const _ as usize
        },
        24usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    pub fn JS_EnableIsErrorProperty(
        ctx: *mut JSContext,
...
extern "C" {
    pub fn JS_GetImportMeta(
        ctx: *mut JSContext,
        m: *mut JSModuleDef,
    ) -> JSValue;
}
extern "C" {
    pub fn JS_GetModuleName(ctx: *mut JSContext, m: *mut JSModuleDef)
        -> JSAtom;
}
...
pub union JSCFunctionType {
    ...
    pub f_f_f: ::std::option::Option<
        unsafe extern "C" fn(arg1: f64, arg2: f64) -> f64,
    >,
...
fn bindgen_test_layout_JSCFunctionType() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionType>())).generic as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionType>())).generic_magic
                as *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionType>())).constructor_magic
                as *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionType>())).f_f_f as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionType>())).getter as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionType>())).setter as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionType>())).iterator_next
                as *const _ as usize
        },
        0usize,
        concat!(
...
fn bindgen_test_layout_JSCFunctionListEntry__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionListEntry__bindgen_ty_1>()))
                .getset as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionListEntry__bindgen_ty_1>())).str
                as *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionListEntry__bindgen_ty_1>())).i32
                as *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionListEntry__bindgen_ty_1>())).i64
                as *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionListEntry__bindgen_ty_1>())).f64
                as *const _ as usize
        },
        0usize,
        concat!(
...
fn bindgen_test_layout_JSCFunctionListEntry() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionListEntry>())).name as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionListEntry>())).prop_flags
                as *const _ as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionListEntry>())).def_type
                as *const _ as usize
        },
        9usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<JSCFunctionListEntry>())).u as *const _
                as usize
        },
        16usize,
        concat!(
...
extern "C" {
    pub fn JS_DupValue_noinl(ctx: *mut JSContext, v: JSValue) -> JSValue;
}
extern "C" {
    pub fn JS_FreeValue_noinl(ctx: *mut JSContext, v: JSValue);
}
extern "C" {
    pub fn JS_IsBool_noinl(v: JSValue) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn JS_IsNull_noinl(v: JSValue) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn JS_IsUndefined_noinl(v: JSValue) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn JS_IsException_noinl(v: JSValue) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn JS_IsString_noinl(v: JSValue) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn JS_IsSymbol_noinl(v: JSValue) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn JS_IsObject_noinl(v: JSValue) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn JS_NewBool_noinl(
        ctx: *mut JSContext,
        val: ::std::os::raw::c_int,
    ) -> JSValue;
}
extern "C" {
    pub fn JS_NewFloat64_noinl(ctx: *mut JSContext, d: f64) -> JSValue;
}
extern "C" {
    pub fn JS_ToCString_noinl(
        ctx: *mut JSContext,
        val: JSValue,
    ) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn JS_GetProperty_noinl(
        ctx: *mut JSContext,
        this_obj: JSValue,
        prop: JSAtom,
    ) -> JSValue;
